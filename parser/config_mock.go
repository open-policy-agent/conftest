...
func (m *MockCustomConfigManager) GetConfigurations(ctx context.Context, input string, fileList []string) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfigurations", ctx, input, fileList)
...
func (mr *MockCustomConfigManagerMockRecorder) GetConfigurations(ctx, input, fileList interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConfigurations", reflect.TypeOf((*MockCustomConfigManager)(nil).GetConfigurations), ctx, input, fileList)
}
